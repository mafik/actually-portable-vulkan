...
It builds upon Actually Portable Executables (a pretty cursed executable format) & foreign-dlopen (another proof-of-concept that allows statically-linked binary to dlopen shared libraries on any host OS).
